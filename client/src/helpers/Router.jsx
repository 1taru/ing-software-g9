...
import { Dashboard, Inicio, Login, Register, Logout, OrdersMenu, AllUsers, CreateOrder, CreateProduct, CreateMaterial, InventoryMenu, UmbralMenu, OrderMenuOperario, OrderMenuModificar } from '../pages'
...
export const Router = () => {
  ...
  return (
    ...
    <Routes>
        ...
        <Route path='/OrderOperario' element={user ? (user.accType === 'acctype1' || user.accType === 'acctype3' || user.accType === 'acctype2' ? (<OrderMenuOperario />) : (<Inicio />)) : (<Login />)} />
        <Route path='/OrderModificar' element={user ? (user.accType === 'acctype1' || user.accType === 'acctype3' || user.accType === 'acctype2' ? (<OrderMenuModificar />) : (<Inicio />)) : (<Login />)} />
